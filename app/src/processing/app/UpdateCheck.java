...
public class UpdateCheck implements Runnable {
  Base base;
  String downloadURL = _("https://raw.github.com/stg/DevSoundIDE/master/version.txt");
  ...
  public void run() {
    ...
    try {
      ...
      String prompt =
        _("A new version of DevSounde IDE is available,\n" +
      ...
      if (base.activeEditor != null) {
        if (latest > Base.REVISION) {
          ...
          if (result == JOptionPane.YES_OPTION) {
            Base.openURL(_("https://github.com/stg/DevSoundIDE/wiki/Installing-the-IDE"));
          }
        }
      }
    } catch (Exception e) {
