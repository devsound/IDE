...
public class Editor extends JFrame implements RunnerListener {
  ...
  JMenuItem uploadUsingProgrammerItem;
...
//          System.err.println("activate");  // not coming through
		  ...
		  toolsMenu.insert(modeMenu, numTools   + 3);
        }
...
//  }
  ...
  protected JMenu buildFileMenu() {
    ...
    uploadUsingProgrammerItem = newJMenuItemShift(_("Upload Using Programmer"), 'U');
    uploadUsingProgrammerItem.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          handleExport(true);
        }
      });
    fileMenu.add(uploadUsingProgrammerItem);
...
//    sketchMenu.add(item);
  ...
  protected JMenu buildToolsMenu() {
    ...
    if (modeMenu == null) {
      modeMenu = new JMenu(_("Programming Mode"));
      base.rebuildModeMenu(modeMenu, this);
    }
    menu.add(modeMenu);
...
*/
    ...
    item = new JMenuItem(_("Visit DevSound online"));
    item.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          Base.openURL(_("http://devsound.se/"));
        }
      });
    menu.add(item);
    ...
    if (!Base.isMacOS()) {
      menu.addSeparator();
      item = new JMenuItem(_("About DevSound IDE"));
      item.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            base.handleAbout();
          }
...
//    e.printStackTrace();
  ...
  private void updateToolsMenu() {
    ...
    if(buildCore == null) buildCore = "";
    programmerMenu.setEnabled(buildCore.equals("arduino"));
    modeMenu.setEnabled(!buildCore.equals("arduino"));
    uploadUsingProgrammerItem.setEnabled(buildCore.equals("arduino"));
  }
