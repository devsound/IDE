...
import processing.app.debug.MakeUploader;
...
//    }
  ...
  public void prepare() {
    ...
    cleanup();
//    File sketchFolder = new File(tempBuildFolder, "sketch");
//    if(!sketchFolder.exists()) sketchFolder.mkdir();
...
//    }
  ...
  protected String upload(String buildPath, String suggestedClassName, boolean usingProgrammer)
    ...
    boolean success = uploader.uploadUsingPreferences(this, buildPath,
                                                      suggestedClassName,
                                                      usingProgrammer);
