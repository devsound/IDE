...
void codec_q(uint8_t register, uint16_t value, uint16_t mask);
void codec_flush();
...
__attribute__((__always_inline__))
inline void codec_llinein  (struct CODEC_LINEIN_t    value) { codec_q(CODEC_LLINEIN,   value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_rlinein  (struct CODEC_LINEIN_t    value) { codec_q(CODEC_RLINEIN,   value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_lheadout (struct CODEC_HEADOUT_t   value) { codec_q(CODEC_LHEADOUT,  value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_rheadout (struct CODEC_HEADOUT_t   value) { codec_q(CODEC_RHEADOUT,  value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_apath    (struct CODEC_APATH_t     value) { codec_q(CODEC_APATH,     value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_dpath    (struct CODEC_DPATH_t     value) { codec_q(CODEC_DPATH,     value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_powerdown(struct CODEC_POWERDOWN_t value) { codec_q(CODEC_POWERDOWN, value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_interface(struct CODEC_INTERFACE_t value) { codec_q(CODEC_INTERFACE, value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_sampling (struct CODEC_SAMPLING_t  value) { codec_q(CODEC_SAMPLING,  value.raw, ~0); }
__attribute__((__always_inline__))
inline void codec_control  (struct CODEC_CONTROL_t   value) { codec_q(CODEC_CONTROL,   value.raw, ~0); }
