...
/*
  // uDAD R001
  { NULL },
  { &PORTA, &GPIOA, 0, 7, 3, &FTM0, 6, 31 }, //  1 PTA0 7:SWD_CLK  3:FTM0_CH5
  { &PORTA, &GPIOA, 3, 7, 3, &FTM0, 0, 31 }, //  2 PTA3 7:SWD_DIO  3:FTM0_CH0
  { &PORTD, &GPIOD, 4, 1, 4, &FTM0, 4, 31 }, //  3 PTD4            4:FTM0_CH4
  { &PORTC, &GPIOC, 7, 1, 0,  NULL, 0, 31 }, //  4 PTC7          
  { &PORTC, &GPIOC, 4, 1, 4, &FTM0, 3, 31 }, //  5 PTC4            4:FTM0_CH3
  { &PORTA, &GPIOA, 4, 1, 3, &FTM0, 1, 31 }, //  6 PTA4            3:FTM0_CH1
  { NULL }, //  7
  { NULL }, //  8
  { NULL }, //  9
  { NULL }, // 10
  ...
  { NULL }, // 19
  { NULL }, // 20
  { &PORTB, &GPIOB, 0, 2, 3, &FTM1, 0,  0,  8 }, // 21 PTB0 2:I2C_SCL  3:FTM1_CH0  0:ADC0_SE8
  { &PORTB, &GPIOB, 1, 2, 3, &FTM1, 1,  0,  9 }, // 22 PTB1 2:I2C_SDA  3:FRM1_CH1  0:ADC0_SE9
  { &PORTD, &GPIOD, 5, 0, 4, &FTM0, 5,  0,  6 }, // 23 PTD5 0:AIN1     4:FTM0_CH5  0:ADC0_SE6b
  { &PORTD, &GPIOD, 6, 0, 4, &FTM0, 6,  0,  7 }, // 24 PTD6 0:AIN0     4:FTM0_CH6  0:ADC0_SE7b
  { &PORTA, &GPIOA, 1, 2, 3, &FTM0, 6,  0, 31 }, // 25 PTA1 2:RX       3:FTM0_CH6
  { &PORTD, &GPIOD, 7, 2, 4, &FTM0, 7,  0, 31 }, // 26 PTD7 3:TX       4:FTM0_CH7
  { NULL }, // 27
  { NULL }, // 28
*/
};
