...
extern uint32_t __fastcode_load, __fastcode_start, __fastcode_end;
extern uint32_t __data_load, __data_start, _edata;
...
//  memcpy(&__fastcode_load, &__fastcode_start, (uintptr_t)&__fastcode_end - (uintptr_t)&__fastcode_start);
  memcpy(&__data_start, &__data_load, (uintptr_t)&_edata - (uintptr_t)&__data_start);
